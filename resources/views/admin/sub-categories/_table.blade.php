            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu" style="">
                  <a class="dropdown-item" href="{{ url('admin/sub-categories/edit/' . $record->id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                  <a class="dropdown-item confirm" href="{{ url('admin/sub-categories/delete/' . $record->id) }}"><i class="bx bx-trash me-1"></i> Delete</a>
                </div>
              </div>
            </td>
          </tr>
